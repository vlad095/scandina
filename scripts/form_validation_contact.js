...
function validate_name_en() {
    ...
    errorMessage = document.getElementById("error-contact-name-en");
...
function validate_name_no() {
    accept = REGEX_NAME.test(document.contactForm.name.value);
    errorMessage = document.getElementById("error-contact-name-no");
...
function validate_name_sr() {
    accept = REGEX_NAME.test(document.contactForm.name.value);
    errorMessage = document.getElementById("error-contact-name-sr");
...
function validate_surname_en() {
    ...
    errorMessage = document.getElementById("error-contact-surname-en");
...
function validate_surname_no() {
    accept = REGEX_NAME.test(document.contactForm.surname.value);
    errorMessage = document.getElementById("error-contact-surname-no");
...
function validate_surname_sr() {
    accept = REGEX_NAME.test(document.contactForm.surname.value);
    errorMessage = document.getElementById("error-contact-surname-sr");
...
function validate_email_en() {
    ...
    errorMessage = document.getElementById("error-contact-email-en");
...
function validate_email_no() {
    accept = REGEX_EMAIL.test(document.contactForm.email.value);
    errorMessage = document.getElementById("error-contact-email-no");
...
function validate_email_sr() {
    accept = REGEX_EMAIL.test(document.contactForm.email.value);
    errorMessage = document.getElementById("error-contact-email-sr");
...
function validate_subject_en() {
    ...
    errorMessage = document.getElementById("error-contact-subject-en");
...
function validate_subject_no() {
    accept = REGEX_SUBJECT.test(document.contactForm.subject.value);
    errorMessage = document.getElementById("error-contact-subject-no");
...
function validate_subject_sr() {
    accept = REGEX_SUBJECT.test(document.contactForm.subject.value);
    errorMessage = document.getElementById("error-contact-subject-sr");
...
function validate_message_en() {
    ...
    errorMessage = document.getElementById("error-contact-message-en");
...
function validate_message_no() {
    accept = REGEX_MESSAGE.test(document.contactForm.message.value);
    errorMessage = document.getElementById("error-contact-message-no");
...
function validate_message_sr() {
    accept = REGEX_MESSAGE.test(document.contactForm.message.value);
    errorMessage = document.getElementById("error-contact-message-sr");
